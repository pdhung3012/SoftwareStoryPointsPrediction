...
# set file directory
nameSystem='bamboo'
fopVectorAllSystems = 'vector_d2v/'
fopOverallResultReg= 'result_d2v/'
   ...
   # fnAll='_10cv.csv'
    ...
    classifiers = [DecisionTreeRegressor(),
                ...
                max_depth = 5, alpha = 10, n_estimators = 10),
                   LinearSVR(C=1,random_state=random_seed),
    ...
    for classifier in classifiers:
        ...
        # X_train, X_val, y_train, y_val = train_test_split(all_data, all_label, test_size=0.9, shuffle=False,
        #                                                     stratify=None)
        dictReverse={}
