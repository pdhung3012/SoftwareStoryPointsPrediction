...
fopVectorAllSystems='data/testVectorSystems_Tfidf4_depends_dm/'
fopTextPreprocess='data/textPreprocess_Tfidf4_depends_dm/'
fopDataset='../dataset/'
import Levenshtein
...
for file in arrFiles:
    ...
    #     continue
    if not file.endswith('datamanagement.csv'):
        continue
    ...
    X4 = getPCAFromTFIDFVector(Text4, ng-3, nc)
