...
def convertTopLabelToNormalLabel(topColumn):
    ...
    for item in topColumn:
        ...
        intVal=int(intVal)
        # print('{} {} {}'.format(intVal,minValue,maxValue))
        if intVal<=minValue:
            intVal=1
...
# set file directory
fopVectorAllSystems = 'data/testVectorSystems_Tfidf4_org_2/'
fopOverallResultReg= 'result/tfidf_dep_regression_82/'
...
for file in arrFiles:
   ...
   # fnAll='_10cv.csv'
    ...
    classifiers = [DecisionTreeRegressor(),RandomForestRegressor(random_state=2, n_estimators=1000),
                  AdaBoostRegressor(), xgb.XGBRegressor(objective ='reg:linear', colsample_bytree = 0.3, learning_rate = 0.1,
