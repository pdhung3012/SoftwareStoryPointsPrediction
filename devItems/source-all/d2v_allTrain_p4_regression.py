...
fopOverallResultReg= 'result/d2v_regression/'
...
for file in arrFiles:
   ...
   # fnAll='_10cv.csv'
    ...
    classifiers = [DecisionTreeRegressor(),
                   RandomForestRegressor(random_state=0, n_estimators=1000),AdaBoostRegressor(), xgb.XGBRegressor(objective ='reg:linear', colsample_bytree = 0.3, learning_rate = 0.1,
