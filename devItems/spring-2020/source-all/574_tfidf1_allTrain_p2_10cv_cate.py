...
fopOverallResultCate='result/574_ast_cate/'
...
fpAllAccInfo = fopOutputItemChart + 'Acc.txt'
...
for classifier in classifiers:
    ...
    try:
        ...
        normalAvg = accuracy_score(y_train, predicted) * 100
        ...
        o2.write(str(confusion_matrix(y_train, predicted)) + '\n')
        o2.write(str(classification_report(y_train, predicted)) + '\n')
        o2.close()
...
print(maxIndexMAE)
o3 = open(fpAccMax, 'a')
o3.write('{}\t{}\n'.format( arrClassifierName[maxIndexMAE], bestAcc))
o3.close()

o3 = open(fpAccMin, 'a')
o3.write('{}\t{}\n'.format( arrClassifierName[minIndexMAE], worstAcc))
o3.close()
...
o3 = open(fpAllAccInfo, 'w')
for i in range(0,len(arrAccuracy)):
    o3.write('{}\t{}\n'.format(arrXBar[i],arrAccuracy[i]))
o3.close()
