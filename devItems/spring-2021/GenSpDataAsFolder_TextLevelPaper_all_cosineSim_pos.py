...
if __name__ == "__main__":
    ...
    fpResultCosine = fopFatherFolder + "/resultPOSJaccard.txt"
    ...
    for filename in list_dir:
        ...
        fopOutputCosineApp = fopFatherFolder + fnSystemAbbrev + '/posJaccardDistance/'
        ...
        for i in range(0, len(raw_data['description'])):
            ...
            titles_and_descriptions.append(str(strContentPos))
