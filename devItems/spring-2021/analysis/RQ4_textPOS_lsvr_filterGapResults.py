...
import sys
sys.path.append('../')
from UtilFunctions import createDirIfNotExist,preprocessTextV3,filterGapLabels

fopOutput='../../../../dataPapers/analysisSEE/'
fopOutputAllSystems=fopOutput+'/RQ4_lsvr_filterGapResults/'
...
for i in range(0,len(list_files)):
    ...
    y_test,predicted=filterGapLabels(y_test,predicted,percentRemove)
