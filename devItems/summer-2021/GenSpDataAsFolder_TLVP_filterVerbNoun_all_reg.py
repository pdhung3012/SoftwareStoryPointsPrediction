...
from UtilFunctions import createDirIfNotExist,scoreName,preprocessFilterOnlyVerbNoun
import nltk
from nltk.tokenize import word_tokenize
...
if __name__ == "__main__":
    ...
    for filename in list_dir:
        ...
        fopOutputDs = fopFatherFolder+'verbNoun_'+fnSystemAbbrev+'/'
        fpOutputTextIndex = fopFatherFolder+'verbNoun_'+fnSystemAbbrev+'.txt'
        fpOutputTextTrainIndex = fopFatherFolder +'verbNoun_'+ fnSystemAbbrev + '.train.txt'
        fpOutputTestLbl= fopFatherFolder+'verbNoun_' + fnSystemAbbrev + '_testLblStep1.txt'
        ...
        for i in range(0, len(df['description'])):
            ...
            strContent=preprocessFilterOnlyVerbNoun(strContent,ps,lemmatizer).strip()
